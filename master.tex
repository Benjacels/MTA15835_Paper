...
\title{Lost on Earth: How Play While Navigating Affects a
Location-Based Game Experience for Tourist Families }
...
\input{introduction}
\input{background}
\input{background_lbgdefinition}
\input{background_playgame}
\input{background_lbgnarrative}
\input{background_lbgnavigation}
\input{background_researchquestion}
\input{preliminarystudy}
\input{design}
\input{experiment}
\input{conclusion}
\input{discussion}
